...
nmpc.p.index.circle_azimut      = 3;  % Azimut of Circle Center
nmpc.p.index.circle_elevation   = 4;  % Elevation of Circle Center
nmpc.p.index.m                  = 5;  % Mass of the aircraft
nmpc.p.index.clA                = 6;  % Lift coefficient (0.5*rho*A*cl)
nmpc.p.index.cdA                = 7;  % Drag coefficient (0.5*rho*A*cd)
nmpc.p.index.init               = 8;  % Initialization boolean in cost function
