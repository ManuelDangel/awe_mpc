...
out[8] = ((((((a[58]*a[2])*a[3])*a[28])+(((a[1]*a[2])*a[3])*a[71]))*a[53])+((((a[1]*a[2])*a[3])*a[28])*a[84]));
out[9] = ((((((a[1]*a[2])*a[85])*a[28])+(((a[1]*a[2])*a[3])*a[92]))*a[53])+((((a[1]*a[2])*a[3])*a[28])*a[99]));
out[10] = (((((a[1]*a[2])*a[3])*a[108])*a[53])+((((a[1]*a[2])*a[3])*a[28])*a[117]));
out[11] = ((((a[1]*a[118])*a[3])*a[28])*a[53]);
out[12] = (((((a[1]*a[2])*a[3])*a[119])*a[53])+((((a[1]*a[2])*a[3])*a[28])*a[120]));
...
out[5] = (real_t)(0.0000000000000000e+00);
out[6] = (real_t)(0.0000000000000000e+00);
out[7] = ((((((a[58]*a[2])*a[3])*a[28])+(((a[1]*a[2])*a[3])*a[71]))*a[53])+((((a[1]*a[2])*a[3])*a[28])*a[84]));
out[8] = ((((((a[1]*a[2])*a[85])*a[28])+(((a[1]*a[2])*a[3])*a[92]))*a[53])+((((a[1]*a[2])*a[3])*a[28])*a[99]));
out[9] = (((((a[1]*a[2])*a[3])*a[108])*a[53])+((((a[1]*a[2])*a[3])*a[28])*a[117]));
out[10] = ((((a[1]*a[118])*a[3])*a[28])*a[53]);
out[11] = (((((a[1]*a[2])*a[3])*a[119])*a[53])+((((a[1]*a[2])*a[3])*a[28])*a[120]));
}
